...
def run():
    anchor_tags = activities[0].findChildren("a", recursive=True,
                                             class_='group flex h-full items-stretch overflow-hidden rounded-lg border border-gray-100')
...
if __name__ == "__main__":
    ...
    activities = soup.find_all('div', class_='user-activity-feed')


    # Extract details of each activity
    # get kids of activities
