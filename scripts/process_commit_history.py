...
if __name__ == "__main__":
    ...
    df_legacy_evolution_errors = exclude_failed_repos(df_legacy_evolution_commits, df_legacy_evolution_errors)
    ...
    df_recent_evolution_errors = exclude_failed_repos(df_recent_evolution_commits, df_recent_evolution_errors)
