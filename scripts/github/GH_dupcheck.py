...
def remove_duplicates(filename):
    ...
    return len(data), len(data) - len(unique_items)
...
if __name__ == '__main__':
    ...
    total, num_duplicates = remove_duplicates(filename)
    print(f"Number of duplicate entries removed: {num_duplicates}. Previous size of the file: {total}. New size of the file: {total - num_duplicates}.")